            ...
            <div className="service rounded-2xl pt-8 pb-8 flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col px-7 gap-4">
                    <div className="flex gap-4 h-2/5">
                        <img src={image1} className="w-3/4 rounded-lg" alt="service1"/>
                        <img src={image2} className="w-1/4 rounded-lg" alt="service2"/>
                    </div>
                    <div className="flex gap-4 h-3/5">
                        <img src={image3} className="w-1/2 rounded-lg" alt="service3"/>
                        <img src={image4} className="w-1/2 rounded-lg" alt="service4"/>
                    </div>
                </div>
            </div>
        </>
